    ...
    resources: {
      ...
      tr: {
        translation: {
          ...
          form_info: 'Bu sizi satın alma yapmaya zorlamaz.',
          send: 'Mesaj gönder',
          sending: 'Gönderiliyor',
          title: 'Şimdi Sorgula',
          subtitle:
            'Vizyonunuza özel kat planlarını, kaplamaları ve kişiselleştirilmiş seçenekleri keşfetmek için ekibimizle iletişime geçin.',
          'Your name': 'Adınız:',
          'Your phone': 'Telefonunuz:',
          'Your email': 'E-postanız:',
          'Your comment': 'Yorumunuz:',
          'Type your message': 'Mesajınızı yazın',
          'Type your name': 'Adınızı yazın',
          'Type your email': 'E-postanızı yazın',
          name_too_short: 'Ad en az {{cnt}} karakter olmalıdır',
          field_too_short: 'Telefon en az {{cnt}} karakter olmalıdır',
          field_too_long: 'Telefon en fazla {{cnt}} karakter olmalıdır',
          field_only_letter: 'Ad yalnızca harf içermelidir',
          field_more_letter: 'Ad en fazla 30 harf olmalıdır',
          invalid_email_format: 'Geçersiz e-posta formatı',
          only_number: 'Buraya yalnızca rakam girin',
          required: 'Bu alan zorunludur',
          sendingSuccessTitle: 'Talebiniz için teşekkür ederiz!',
          sendingSuccessText: 'Yöneticilerimizin yanıtını bekleyin',
          sendingErrorText: 'Yöneticilerimizin yanıtını bekleyin',
          sendingErrorTitle: 'Bir hata oluştu',
          send_fail: 'Mesaj bilinmeyen bir sunucu hatası nedeniyle gönderilemedi. Kod: [send_fail]',
          invalid_form:
            'Mesaj bilinmeyen bir sunucu hatası nedeniyle gönderilemedi. Kod: [invalid_form]',
          front_error:
            'Mesaj bilinmeyen bir sunucu hatası nedeniyle gönderilemedi. Kod: [front_error]',
          invalid_upload_file: 'Dosya yükleme hatası. Kod: [invalid_upload_file]',
          invalid_recaptcha:
            "Lütfen captcha'yı doldurun ve tekrar deneyin. Kod: [invalid_recaptcha]",
